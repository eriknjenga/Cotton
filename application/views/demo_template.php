				...
				<div id="top">
					...
					<div class="meta">
						...
						<ul>
							...
							<li>
								<a href="<?php echo site_url("user_management/change_password");?>" title="Change My Password" class="tooltip"><span class="ui-icon ui-icon-wrench"></span>Change My Password</a>
							</li>
						</ul>
					</div>
