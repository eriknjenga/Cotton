...
?>
<h1>Cash Disbursement Route Listing</h1><a href="<?php echo base_url()."cash_route_management/print_routes";?>" class="button"><span class="ui-icon ui-icon-print"></span>Print</a>
