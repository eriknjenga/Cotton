...
class Weighbridge extends Doctrine_Record {
	...
	public function setUp() {
		...
		$this -> hasOne('Depot as Depot_Object', array('local' => 'Buying_Center_Code', 'foreign' => 'Depot_Code'));
	}

	public function getSearchedTicket($ticket) {
		$query = Doctrine_Query::create() -> select("*") -> from("Weighbridge") -> where("Ticket_Number = '$ticket'");
